...
var itemStyles = [
    ["itemWidth=135px","itemHeight=21px","itemBackColor=transparent,transparent","itemBorderWidth=0","fontStyle=normal 11px Tahoma","fontColor=#1A3953,#000000","itemBackImage=menue/atc_main.files/btn3_white.gif,menue/atc_main.files/btn3_white.gif"],
];
var menuStyles = [
